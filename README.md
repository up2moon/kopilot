...
| ----------- | ------------------------------------------------------------------- |
| 프로젝트    | Kospay                                                              |
| 구분        | 코스콤 2026년 상반기 신입사원 미니프로젝트 2조                      |
| 형태        | 모바일 우선 반응형 웹 서비스                                        |
...
# 종목 분석 에이전트 뉴스 검색
OPENAI_INVESTMENT_AGENT_MODEL=
NAVER_API_CLIENT_ID=
NAVER_API_SECRET_KEY=
FIRECRAWL_API_KEY=
# 기존 오탈자 FIRECRALW_API_KEY도 호환되지만 위 표준 이름을 권장
INVESTMENT_NEWS_LOOKBACK_DAYS=90
INVESTMENT_NEWS_MAX_RESULTS=24
INVESTMENT_NEWS_NAVER_DISPLAY=30
INVESTMENT_NEWS_FIRECRAWL_LIMIT=15
# 필요할 때 쉼표로 구분해 기본 언론사 허용 목록을 대체
INVESTMENT_NEWS_ALLOWED_DOMAINS=
