...
- `POST /api/investment/sync?mode=all|prices|base-prices&limit=200&months=2026-07`: 코스콤 CHECK API 종목 마스터, 최신 종가, 선택 월 첫 거래일 기준가를 수동 동기화합니다. 배포 직후 초기 적재나 로컬 검증에 사용합니다.
