export const useMockInvestment =
  import.meta.env.DEV || import.meta.env.VITE_USE_MOCK_INVESTMENT === "true";
...
export const mockInvestmentAssets = [
  ...
  {
    assetCode: "233740",
    label: "KB 레버리지 KOSDAQ 150 선물 ETN",
    currentPrice: 17685,
    diffRate: -0.012,
  },
  {
    assetCode: "520009",
    label: "미래에셋 레버리지 삼성전자 ETN",
    currentPrice: 8915,
    diffRate: -0.015,
  },
  {
    assetCode: "442580",
    label: "삼성 iSelect 조선 TOP10 ETN",
    currentPrice: 11070,
    diffRate: 0.009,
  },
  {
    assetCode: "461450",
    label: "삼성 KRX 2차전지 TOP10 ETN",
    currentPrice: 10560,
    diffRate: 0.017,
  },
  {
